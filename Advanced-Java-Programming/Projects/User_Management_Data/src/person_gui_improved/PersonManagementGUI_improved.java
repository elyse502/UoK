...
public class PersonManagementGUI_improved extends JFrame {
    ...
    public PersonManagementGUI_improved() {
        initComponents();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PersonManagementGUI_improved gui = new PersonManagementGUI_improved();
